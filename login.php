...
if(isset($_POST['submit'])){
	...
	if($user->login($username,$password)){ 
		...
		$error[] = 'Inloggen mislukt. Zorg dat je de correcte gegevens invult en dat jouw account geactiveerd is.';
	}
	...
	<div class="row">
	    ...
	    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
			<form role="form" method="post" action="" autocomplete="off">
				<h2>Inloggen</h2>
				<p><a href='./'>Terugkeren naar de homepagina</a></p>
				<hr>
				...
				if(isset($_GET['action'])){
					...
					switch ($_GET['action']) {
						case 'active':
							...
							break;
						case 'reset':
							echo "<h2 class='bg-success'>Controleer je e-mail om je account te resetten.</h2>";
							break;
						case 'resetAccount':
							echo "<h2 class='bg-success'>Wachtwoord aangepast. Je kunt inloggen met het nieuwe wachtwoord.</h2>";
							break;
					}
